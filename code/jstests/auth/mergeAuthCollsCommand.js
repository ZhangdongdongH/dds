...
function runTest(conn) {
    ...
    db.createUser({user: 'spencer', pwd: 'Password@a1b', roles: ['read'], "passwordDigestor" : "server"});
    admin.createUser({user: 'andreas', pwd: 'Password@a1b', roles: ['read'], "passwordDigestor" : "server"});
    ...
    db.createUser({user: 'spencer', pwd: 'Password@a1b', roles: ['readWrite'], "passwordDigestor" : "server"});
    db.createUser({user: 'andy', pwd: 'Password@a1b', roles: ['readWrite'], "passwordDigestor" : "server"});
    admin.createUser({user: 'andreas', pwd: 'Password@a1b', roles: ['readWrite'], "passwordDigestor" : "server"});
    ...
    db.createUser({user: 'bob', pwd: 'Password@a1b', roles: ['read'], "passwordDigestor" : "server"});
    admin.createUser({user: 'george', pwd: 'Password@a1b', roles: ['read'], "passwordDigestor" : "server"});
