...
db1.createUser({user: "foo", pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
db2.createUser({user: "bar", pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
