...
function runTest(db) {
    ...
    assert.throws(function() {
        db.createUser({user: 'user1', pwd: 'Password@a1b', roles: [], digestPassword: true, "passwordDigestor" : "server"});
    });
    assert.throws(function() {
        db.createUser({user: 'user1', pwd: 'Password@a1b', roles: [], digestPassword: false, "passwordDigestor" : "server"});
    });
    assert.throws(function() {
    ...
    assert.throws(function() {
        db.createUser({createUser: 'ben', pwd: 'Password@a1b', roles: ['dbAdmin'], passwordDigestor: "server"});
    });
}
