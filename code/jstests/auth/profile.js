...
var username = "user";
db1.createUser({user: username, pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
db2.createUser({user: username, pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
