...
(function() {
    ...
    inputDb.createUser({user: "admin", pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});

    var outputDb = authenticatedConn.getDB("output");
    outputDb.createUser({user: "admin", pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
