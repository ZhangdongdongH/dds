...
(function() {
    ...
    function testConnection(
        ...
        assert.commandWorked(admin.runCommand({createUser: "user3", pwd: "Password@a1b", roles: [], "digestPassword" : true}));
        assert.commandWorked(admin.runCommand(
        ...
        assert.commandWorked(admin.runCommand(
            {createUser: "user4", pwd: "Password@a1b", roles: [], authenticationRestrictions: [], "digestPassword" : true}));
        ...
        assert.commandWorked(admin.runCommand({createUser: "user5", pwd: "Password@a1b", roles: [], "digestPassword" : true}));
        ...
        assert.commandWorked(admin.runCommand({
            ...
            authenticationRestrictions:
                [{clientSource: ["127.0.0.1"], serverAddress: ["127.0.0.1"]}], "digestPassword" : true
        }));
        assert.commandWorked(admin.runCommand({
            createUser: "user9",
            pwd: "Password@a1b",
        ...
        assert.commandFailed(admin.runCommand({
            ...
            pwd: "Password@a1b",
            roles: [],
            authenticationRestrictions: [{invalidRestriction: ["127.0.0.1"]}], "digestPassword" : true
        }));
        ...
        assert.commandWorked(admin.runCommand(
            {createUser: "user12", pwd: "Password@a1b", roles: [{role: "readWrite", db: "test"}], "digestPassword" : true}));
