...
testDb.createUser({user: 'readUser', pwd: 'Password@a1b', roles: ['read'], "passwordDigestor" : "server"});
adminDb.createUser({user: 'monitor', pwd: 'Password@a1b', roles: [{ 'role': 'dbAdmin', 'db':'testdb'}], "passwordDigestor" : "server"});
