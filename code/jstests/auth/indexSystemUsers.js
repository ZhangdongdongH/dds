...
adminDB.createUser({user: 'admin', pwd: 'Password@a1b', roles: ['userAdminAnyDatabase'], "passwordDigestor" : "server"});
adminDB.auth('admin', 'Password@a1b');
adminDB.createUser({user: 'monitor', pwd: 'Password@a1b', roles: ['readWriteAnyDatabase'], "passwordDigestor" : "server"});
testDB.createUser({user: 'user', pwd: 'Password@a1b', roles: ['read'], "passwordDigestor" : "server"});
