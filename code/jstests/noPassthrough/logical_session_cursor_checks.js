...
(function() {
    ...
    function runFixture(Fixture) {
        ...
        data.createUser({user: 'admin', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        data.createUser({user: 'user0', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        admin.logout();
