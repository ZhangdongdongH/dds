...
var _kill_sessions_api_module = (function() {
    ...
    KillSessionsTestHelper.initializeAuth = function(client) {
        ...
        admin.createUser({user: 'super', pwd: 'Password@a1b', roles: jsTest.adminUserRoles, "passwordDigestor" : "server"});
        ...
        admin.createUser({user: 'simple', pwd: 'Password@a1b', roles: ['forSimpleTest'], "passwordDigestor" : "server"});
        admin.createUser({user: 'simple2', pwd: 'Password@a1b', roles: ['forSimpleTest'], "passwordDigestor" : "server"});
        admin.createUser({user: 'killAny', pwd: 'Password@a1b', roles: ['killAnySession'], "passwordDigestor" : "server"});
        admin.createUser(
            {user: 'impersonate', pwd: 'Password@a1b', roles: ['forImpersonate', 'killAnySession'], "passwordDigestor" : "server"});
    };
