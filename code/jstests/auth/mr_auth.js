...
d.dropAllUsers();
d.getSisterDB("admin").createUser({user: "admin1", pwd: "Password@a1b", roles: jsTest.adminUserRoles, "passwordDigestor" : "server"});
d.getSisterDB("admin").auth('admin1', 'Password@a1b');
d.createUser({user: "write", pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
d.createUser({user: "read", pwd: "Password@a1b", roles: jsTest.readOnlyUserRoles, "passwordDigestor" : "server"});
