...
(function() {
    ...
    function runListSessionsTest(mongod) {
        ...
        admin.createUser({user: 'user1', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        admin.createUser({user: 'user2', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        admin.logout();
