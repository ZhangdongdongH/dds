...
(function() {
    ...
    test.createUser({user: '__system', pwd: 'Github@12', roles: [], "passwordDigestor" : "server"});
    admin.createUser({user: '__system', pwd: 'Github@12', roles: [], "passwordDigestor" : "server"});
    assert.throws(function() {
        local.createUser({user: '__system', pwd: 'Github@12', roles: [], "passwordDigestor" : "server"});
    });
    ...
    //
    assert(!local.auth('__system', 'Github@12'));
    assertCountUnauthorized(conn, "admin", "foo");
    assertCountUnauthorized(conn, "local", "foo");
    assertCountUnauthorized(conn, "test", "foo");
