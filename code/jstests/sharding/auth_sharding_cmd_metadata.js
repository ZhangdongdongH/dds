...
(function() {
    ...
    st.s.getDB(adminUser.db).createUser({user: 'admin', pwd: 'Password@a1b', roles: jsTest.adminUserRoles, "passwordDigestor" : "server"});
    ...
    st.d0.getDB('admin').createUser({user: 'omuser', pwd: 'Password@a1b', roles: jsTest.adminUserRoles, "passwordDigestor" : "server"});
    ...
    st.d0.getDB('admin').createUser({user: 'internal', pwd: 'Password@a1b', roles: ['__system'], "passwordDigestor" : "server"});
