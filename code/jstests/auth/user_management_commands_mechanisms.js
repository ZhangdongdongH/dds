...
(function() {
    ...
    // Request SHA1 only.
    test.createUser(
        {user: 'sha1user', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, mechanisms: ['SCRAM-SHA-1']});
    ...
    assert.throws(function() {
        test.createUser(
            {user: 'userNoMech', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, mechanisms: []});
    });
    ...
    test.createUser(
        {user: "\u2168", pwd: 'Password@a1b', roles: jsTest.basicUserRoles, mechanisms: ['SCRAM-SHA-1']});
