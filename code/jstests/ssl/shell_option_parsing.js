...
(function() {
    ...
    mongod.getDB("test").createUser({user: username, pwd: password, roles: [], "passwordDigestor" : "server"});
    mongod.getDB("notTest").createUser({user: usernameNotTest, pwd: passwordNotTest, roles: [], "passwordDigestor" : "server"});
