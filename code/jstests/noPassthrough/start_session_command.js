(function() {
    ...
    admin.createUser({user: 'user0', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
    foo.createUser({user: 'user1', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
