...
function runTest(conn) {
    ...
    conn.getDB('admin').createUser({user: 'normal_user', pwd: 'Password@a1b', roles: ['root'], "passwordDigestor" : "server"});
    ...
    admin.createUser({user: 'spencer', pwd: 'Password@a1b', roles: ['myRole'], "passwordDigestor" : "server"});
