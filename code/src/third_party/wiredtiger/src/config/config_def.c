...
static const WT_CONFIG_CHECK confchk_WT_CONNECTION_reconfigure[] = {
	...
	{ "eviction_dirty_trigger", "int",
	    NULL, "min=1,max=99",
	    NULL, 0 },
	{ "eviction_skip_wtnotfound", "boolean", NULL, NULL, NULL, 0 },
...
static const WT_CONFIG_ENTRY config_entries[] = {
	...
	{ "WT_CONNECTION.reconfigure",
	  ...
	  "eviction_dirty_trigger=20,eviction_skip_wtnotfound=true,"
	...
	{ "wiredtiger_open",
	  ...
	  "eviction_skip_wtnotfound=true,eviction_target=80,eviction_trigger=95,exclusive=false,"
	...
	{ "wiredtiger_open_basecfg",
	  ...
	  "eviction=(threads_max=8,threads_min=1),"
	  "eviction_checkpoint_target=5,eviction_dirty_target=5,"
	  "eviction_dirty_trigger=20,eviction_skip_wtnotfound=true,eviction_target=80,eviction_trigger=95"
	  ",extensions=,file_extend=,file_manager=(close_handle_minimum=250"
	  ",close_idle_time=30,close_scan_interval=10),hazard_max=1000,"
