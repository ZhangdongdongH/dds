...
(function() {
    ...
    shardAdmin.createUser(
        {user: 'admin', pwd: 'Password@a1b', roles: ['clusterAdmin', 'userAdminAnyDatabase'], "passwordDigestor" : "server"});
    ...
    shardAdmin.auth('admin', 'Password@a1b');
    fooDB.createUser({user: 'user', pwd: 'Password@a1b', roles: ['readWrite', 'dbAdmin'], "passwordDigestor" : "server"});
    shardAdmin.logout();
