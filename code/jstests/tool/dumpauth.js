...
db.createUser({user: "admin", pwd: "Password@a1b", roles: jsTest.adminUserRoles, "passwordDigestor" : "server"});
...
db.createUser({user: "backup", pwd: "Password@a1b", roles: ["backup"], "passwordDigestor" : "server"});
