...
(function() {
    ...
    function runListLocalSessionsTest(mongod) {
        ...
        db.createUser({user: 'user1', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        db.createUser({user: 'user2', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        admin.logout();
