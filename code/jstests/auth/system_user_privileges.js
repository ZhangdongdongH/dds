...
(function() {
    ...
    test.createUser({user: '__system', pwd: 'Password@a1b', roles: [], "passwordDigestor" : "server"});
    admin.createUser({user: '__system', pwd: 'Password@a1b', roles: [], "passwordDigestor" : "server"});
    assert.throws(function() {
        local.createUser({user: '__system', pwd: 'Password@a1b', roles: [], "passwordDigestor" : "server"});
    });
