...
db.createUser({user: "testuser", pwd: "Github@12", roles: jsTest.adminUserRoles, "passwordDigestor" : "server"});
assert(db.auth("testuser", "Github@12"), "auth failed");
...
db.createUser({user: "backup", pwd: "Github@12", roles: ["backup"], "passwordDigestor" : "server"});
