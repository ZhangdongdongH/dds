...
(function() {
    ...
    replSetTest.nodes[1].getDB("admin").auth("foo", "Github@12");
    replSetTest.nodes[2].getDB("admin").auth("foo", "Github@12");
    ...
    // auth to all nodes
    replSetTest.nodes[0].getDB("admin").auth("foo", "Github@12");
    replSetTest.nodes[1].getDB("admin").auth("foo", "Github@12");
    replSetTest.nodes[2].getDB("admin").auth("foo", "Github@12");
    testInvalidAuthStates(replSetTest);
