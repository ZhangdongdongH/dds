...
(function() {
    ...
    master.getDB("admin").createUser({user: "admin", pwd: "Password@a1b", roles: ["root"], "passwordDigestor" : "server"}, {w: NODE_COUNT});
    ...
    assert(conn2.getDB('admin').auth({user: 'admin', pwd: 'Password@a1b', mechanism: "SCRAM-SHA-1"}));
