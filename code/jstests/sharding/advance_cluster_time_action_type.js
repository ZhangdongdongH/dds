...
(function() {
    ...
    assert.commandWorked(adminDB.runCommand({createUser: "admin", pwd: "Password@a1b", roles: ["root"], "digestPassword" : true}));
    ...
    assert.commandWorked(
        testDB.runCommand({createUser: 'NotTrusted', pwd: 'Password@a1b', roles: ['readWrite'], "digestPassword" : true}));
