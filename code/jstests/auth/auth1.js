...
function runTest(m) {
    ...
    db.getSisterDB("admin").createUser({user: "admin", pwd: "Password@a1b", roles: ["root"], "passwordDigestor" : "server"});
    ...
    db.getSisterDB("admin").createUser({user: "super", pwd: "Password@a1b", roles: ["__system"], "passwordDigestor" : "server"});
    db.getSisterDB("admin").auth("super", "Password@a1b");
    db.createUser({user: "eliot", pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
    db.createUser({user: "guest", pwd: "Password@a1b", roles: jsTest.readOnlyUserRoles, "passwordDigestor" : "server"});
