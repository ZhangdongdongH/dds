...
function runTest(conn) {
    ...
    conn.getDB('admin').createUser(
        {user: 'userAdmin', pwd: 'Password@a1b', roles: ['userAdminAnyDatabase'], "passwordDigestor" : "server"});
    ...
    testUserAdmin.createUser(
        {user: 'spencer', pwd: 'Password@a1b', roles: ['testRole', {role: 'adminRole', db: 'admin'}], "passwordDigestor" : "server"});
    adminUserAdmin.createUser({user: 'otherUser', pwd: 'Password@a1b', roles: [], "passwordDigestor" : "server"});
    ...
    (function testCreateUser() {
        ...
        var res = db.runCommand({createUser: 'andy', pwd: 'Password@a1b', roles: [], "digestPassword" : true});
        ...
        assert.commandWorked(db.runCommand({createUser: 'andy', pwd: 'Password@a1b', roles: [], "digestPassword" : true}));

        res = admindb.runCommand({createUser: 'andy', pwd: 'Password@a1b', roles: [], "digestPassword" : true});
        assert.commandFailedWithCode(res, authzErrorCode);
    })();
    ...
    (function testGrantRole() {
        ...
        var res = db.runCommand({createUser: 'andy', pwd: 'Password@a1b', roles: ['read'], "digestPassword" : true});
        assert.commandFailedWithCode(res, authzErrorCode);
        ...
        assert.commandWorked(db.runCommand({createUser: 'andy', pwd: 'Password@a1b', roles: ['read'], "digestPassword" : true}));
