...
(function() {
    ...
    function runTest(conn) {
        ...
        assert.commandWorked(
            adminDB.runCommand({createUser: "admin", pwd: "Password@a1b", roles: ["root"], "digestPassword" : true}));
        ...
        assert.commandWorked(
            testDB.runCommand({createUser: "Alice", pwd: "Password@a1b", roles: ["readWrite"], "digestPassword" : true}));
        assert.commandWorked(
            testDB.runCommand({createUser: "Mallory", pwd: "Password@a1b", roles: ["readWrite"], "digestPassword" : true}));
        adminDB.logout();
        ...
        assert.commandWorked(
            testDB.runCommand({createUser: "Bob", pwd: "Password@a1b", roles: ["indexStatsOnly"], "digestPassword" : true}));
        adminDB.logout();
        ...
        assert.commandWorked(
            testDB.runCommand({createUser: "fooUser", pwd: "Password@a1b", roles: ["readFoo"], "digestPassword" : true}));
        ...
        assert.commandWorked(
            adminDB.runCommand({createUser: "fooBarUser", pwd: "Password@a1b", roles: ["readFooBar"]}));
