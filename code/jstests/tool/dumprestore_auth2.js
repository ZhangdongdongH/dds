...
var dumpRestoreAuth2 = function(backup_role, restore_role) {
    ...
    admindb.createUser({user: "backup", pwd: "Github@12", roles: [backup_role], "passwordDigestor" : "server"});
    admindb.createUser({user: "restore", pwd: "Github@12", roles: [restore_role], "passwordDigestor" : "server"});
    ...
    admindb.createUser({user: "test", pwd: "Github@12", roles: ["customRole"], "passwordDigestor" : "server"});
    ...
    admindb.auth("root", "Github@12");
    admindb.createUser({user: "root2", pwd: "Github@12", roles: ["root"], "passwordDigestor" : "server"});
    admindb.dropRole("customRole");
