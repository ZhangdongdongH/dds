...
adminDB.createUser({user: 'userAdmin', pwd: 'Password@a1b', roles: ['userAdminAnyDatabase'], "passwordDigestor" : "server"});

adminDB.auth('userAdmin', 'Password@a1b');
adminDB.createUser({user: 'readWriteAdmin', pwd: 'Password@a1b', roles: ['readWriteAnyDatabase'], "passwordDigestor" : "server"});
adminDB.createUser({
