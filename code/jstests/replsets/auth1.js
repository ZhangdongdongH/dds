...
(function() {
    ...
    m.getDB("admin").createUser({user: "admin", pwd: "Password@a1b", roles: jsTest.adminUserRoles, "passwordDigestor" : "server"});
    m.getDB("test").createUser({user: "bar", pwd: "Password@a1b", roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
