...
test.createUser({user: 'reader', pwd: 'Password@a1b', roles: ["read"], "passwordDigestor" : "server"});
test.createUser({user: 'writer', pwd: 'Password@a1b', roles: ["readWrite"], "passwordDigestor" : "server"});
admin.logout();
