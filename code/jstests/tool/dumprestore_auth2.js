...
var dumpRestoreAuth2 = function(backup_role, restore_role) {
    ...
    admindb.createUser({user: "backup", pwd: "Password@a1b", roles: [backup_role], "passwordDigestor" : "server"});
    admindb.createUser({user: "restore", pwd: "Password@a1b", roles: [restore_role], "passwordDigestor" : "server"});
    ...
    admindb.createUser({user: "test", pwd: "Password@a1b", roles: ["customRole"], "passwordDigestor" : "server"});
    ...
    admindb.auth("root", "Password@a1b");
    admindb.createUser({user: "root2", pwd: "Password@a1b", roles: ["root"], "passwordDigestor" : "server"});
    admindb.dropRole("customRole");
