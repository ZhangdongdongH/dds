...
(function() {
    ...
    function runTest(mongod) {
        ...
        testA.createUser({user: 'user1', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        testA.createUser({user: 'user2', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        testB.createUser({user: 'user3', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        testB.createUser({user: 'user4', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
        admin.logout();
