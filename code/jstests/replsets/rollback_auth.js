...
(function() {
    ...
    A.createUser({user: 'admin', pwd: 'Password@a1b', roles: ['root'], "passwordDigestor" : "server"});
    ...
    A.createUser({user: 'userAdmin', pwd: 'Password@a1b', roles: ['userAdminAnyDatabase'], "passwordDigestor" : "server"});
    ...
    a.createUser(
        {user: 'spencer', pwd: 'Password@a1b', roles: ['myRole', {role: 'replStatusRole', db: 'admin'}], "passwordDigestor" : "server"});
