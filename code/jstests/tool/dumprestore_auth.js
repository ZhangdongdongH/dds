...
adminDB.createUser({user: 'admin', pwd: 'Password@a1b', roles: ['root'], "passwordDigestor" : "server"});
...
testUserAdmin.createUser({user: 'backupFoo', pwd: 'Password@a1b', roles: ['backupFoo'], "passwordDigestor" : "server"});
...
testUserAdmin.createUser({user: 'restoreChester', pwd: 'Password@a1b', roles: ['restoreChester'], "passwordDigestor" : "server"});
testUserAdmin.createUser({user: 'restoreFoo', pwd: 'Password@a1b', roles: ['restoreFoo'], "passwordDigestor" : "server"});
