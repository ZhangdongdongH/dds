...
(function() {
    ...
    commands.push({
        req: {createUser: 'username', pwd: 'Password@a2b', roles: jsTest.basicUserRoles, "digestPassword" : true},
        setupFunc: function() {},
    ...
    commands.push({
        ...
        setupFunc: function() {
            db.runCommand({createUser: 'username', pwd: 'Password@a2b', roles: jsTest.basicUserRoles, "digestPassword" : true});
        },
        confirmFunc: function() {
            assert(!db.auth("username", "Password@a2b"), "auth should have failed");
    ...
    commands.push({
        ...
        setupFunc: function() {
            db.runCommand({createUser: 'tempUser', pwd: 'Password@a2b', roles: jsTest.basicUserRoles, "digestPassword" : true});
