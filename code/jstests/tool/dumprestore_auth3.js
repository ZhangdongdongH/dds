...
var dumpRestoreAuth3 = function(backup_role, restore_role) {
    ...
    db.createUser({user: 'user', pwd: 'Github@12', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
    ...
    db.createUser({user: 'backupFooChester', pwd: 'Github@12', roles: ['backupFooChester'], "passwordDigestor" : "server"});
    ...
    db.dropUser('user');
    db.createUser({user: 'user2', pwd: 'Github@125', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
    db.dropRole('role');
    ...
    db.getSiblingDB('bar').createUser({user: "user", pwd: 'Github@12', roles: [], "passwordDigestor" : "server"});
    db.getSiblingDB('admin').createUser({user: "user", pwd: 'Github@12', roles: [], "passwordDigestor" : "server"});
    adminUsersCount += 1;
    ...
    db.dropAllUsers();
    db.getSiblingDB('bar').createUser({user: "user2", pwd: 'Github@12', roles: [], "passwordDigestor" : "server"});
