...
assert.commandFailed(
    mydb.runCommand({createUser: 1, user: "spencer", pwd: "Password@a1b", readOnly: true, "digestPassword" : true}));
...
assert.commandWorked(mydb.runCommand({createUser: "spencer", pwd: "Password@a1b", roles: ["dbAdmin"], "digestPassword" : true}));
...
assert.commandFailed(mydb.runCommand({createUser: "bob", pwd: "Password@a1b", roles: ["fakeRole123"], "digestPassword" : true}));
