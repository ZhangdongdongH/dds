...
(function() {
    ...
    adminDB.createUser({user: adminUser.username, pwd: adminUser.password, roles: ["__system"], "passwordDigestor" : "server"});
    ...
    priRSConn.createUser({user: rUser.username, pwd: rUser.password, roles: ["root"], "passwordDigestor" : "server"});
