...
(function() {
    ...
    function runTest(conn) {
        ...
        for (let i = 0; i < userCount; ++i) {
            assert.commandWorked(db.runCommand({createUser: "user" + i, pwd: "Password@a1b", roles: []}));
        }
        assert.commandWorked(otherDB.runCommand({createUser: "otherUser", pwd: "Password@a1b", roles: []}));
