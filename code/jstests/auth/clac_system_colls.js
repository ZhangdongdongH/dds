...
function runTest(admindb) {
    ...
    admindb.createUser({user: "sysUser", pwd: "Password@a1b", roles: ["FindOnSysRes"], "passwordDigestor" : "server"});
    admindb.createUser({user: "user", pwd: "Password@a1b", roles: ["FindInDB"], "passwordDigestor" : "server"});
