...
st.s1.getDB('admin').createUser({user: 'admin', pwd: 'Password@a1b', roles: ['root'], "passwordDigestor" : "server"});
...
st.s1.getDB('admin').createUser({user: 'backupuser', pwd: 'Password@a1b', roles: ['userAdminAnyDatabase'], "passwordDigestor" : "server"});
