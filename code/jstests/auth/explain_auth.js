...
admin.createUser({user: "adminUser", pwd: "Password@a1b", roles: ["root"], "passwordDigestor" : "server"});
...
db.createUser({user: "findOnly", pwd: "Password@a1b", roles: ["findOnly"], "passwordDigestor" : "server"});
db.createUser({user: "updateOnly", pwd: "Password@a1b", roles: ["updateOnly"], "passwordDigestor" : "server"});
db.createUser({user: "removeOnly", pwd: "Password@a1b", roles: ["removeOnly"], "passwordDigestor" : "server"});
