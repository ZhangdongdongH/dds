...
function runAllUserManagementCommandsTests(conn, writeConcern) {
    ...
    conn.getDB('admin').createUser({user: 'admin', pwd: 'Password@a1b', roles: ['root'], "passwordDigestor" : "server"}, writeConcern);
    ...
    (function testCreateUser() {
        ...
        testUserAdmin.createUser({user: "andy", pwd: "Password@a1b", roles: [], "passwordDigestor" : "server"}, writeConcern);
    ...
    (function testUpdateUser() {
        ...
        testUserAdmin.getSisterDB('admin').updateUser('monitor', {pwd: 'Password@a1b4', customData: {}, "passwordDigestor" : "server"}, writeConcern);
