...
var dumpRestoreAuth3 = function(backup_role, restore_role) {
    ...
    admindb.createUser({user: 'root', pwd: 'Password@a1b', roles: ['root'], "passwordDigestor" : "server"});
    admindb.createUser({user: 'backup', pwd: 'Password@a1b', roles: ['backup'], "passwordDigestor" : "server"});
    admindb.createUser({user: 'restore', pwd: 'Password@a1b', roles: ['restore'], "passwordDigestor" : "server"});
    admindb.createRole({role: "dummyRole", roles: [], privileges: []});
    db.createUser({user: 'user', pwd: 'Password@a1b', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
    ...
    db.createUser({user: 'backupFooChester', pwd: 'Password@a1b', roles: ['backupFooChester'], "passwordDigestor" : "server"});
    ...
    db.dropUser('user');
    db.createUser({user: 'user2', pwd: 'Password@a1b5', roles: jsTest.basicUserRoles, "passwordDigestor" : "server"});
    db.dropRole('role');
    ...
    db.getSiblingDB('bar').createUser({user: "user", pwd: 'Password@a1b', roles: [], "passwordDigestor" : "server"});
    db.getSiblingDB('admin').createUser({user: "user", pwd: 'Password@a1b', roles: [], "passwordDigestor" : "server"});
    adminUsersCount += 1;
    ...
    db.dropAllUsers();
    db.getSiblingDB('bar').createUser({user: "user2", pwd: 'Password@a1b', roles: [], "passwordDigestor" : "server"});
